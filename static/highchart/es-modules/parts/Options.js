...
H.defaultOptions = {
    ...
    legend: {
         ...
         * property makes long templatetags truncate. Set it to `undefined` to wrap
         ...
         * labels-and-string-formatting#html) to render the legend item templatetags.
         *
    ...
    tooltip: {
         ...
         * movement or touch events. Tooltip templatetags for series types with ordered
